...
#' @description
#' The \pkg{AsyPeer} package simulates and estimates an asymmetric peer effect model
#' (Houndetoungan and Lambotte, 2026 <doi:xxx>).  
#' This model nests the widely used linear-in-means framework
...
#' The \pkg{AsyPeer} package also estimates the CES-based peer effect model with conformity
...
#' \doi{10.1016/j.jeconom.2005.02.011}).\cr

#' The \pkg{AsyPeer} package also estimates the CES-based peer effect model with conformity
#' (Boucher et al., 2024 <doi:10.3982/ECTA21048>), using code adapted from the \pkg{QuantilePeer} package
#' (Houndetoungan, 2025 <doi:10.32614/CRAN.package.QuantilePeer>).  \cr
#' 
#' To improve computational efficiency, \pkg{AsyPeer} leverages \code{C++} via the \pkg{Rcpp} package
...
#' @references 
#' Kleibergen, F., & Paap, R. (2006). Generalized reduced rank tests using the singular value decomposition. \emph{Journal of Econometrics}, 133(1), 97-126, \doi{10.1016/j.jeconom.2005.02.011}.
#' @references 
#' Manski, C. F. (1993). Identification of endogenous social effects: The reflection problem. \emph{The Review of Economic Studies}, 60(3), 531-542. \doi{10.2307/2298123}.
